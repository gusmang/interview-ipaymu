...
const img_assets = "assets/front/images/Carousel/";

var productsName_array = ["Product 1","Product 2","Product 3","Product 4","Product 5","Product 6"];
var productsIndex_array = ["1","2","3","4","5","6"];
var productsDesc_array = ["Some quick example text to build on the card title and make up the bulk of the card's content.","Some quick example text to build on the card title and make up the bulk of the card's content.","Some quick example text to build on the card title and make up the bulk of the card's content","Some quick example text to build on the card title and make up the bulk of the card's content.","Some quick example text to build on the card title and make up the bulk of the card's content.","Some quick example text to build on the card title and make up the bulk of the card's content."];
var productsImg_array = ["1.jpg","2.jpg","3.jpg","3.jpg","2.jpg","1.jpg"];
var productsPrice_array = ["415000","200000","310000","315000","225000","125000"];

function fetch_product(){
    $.ajax({
        type:"GET",
        url:url_menu_apis+"/get_product_list",
        data:"",
        dataType:"json",
