...
<div class="modal fade" id="editedModal" tabindex="-1" role="dialog" aria-labelledby="editedModalLabel" aria-hidden="true">
    <form id="form_multi_edit" name="form_multi_edit" enctype="multipart/form-data" method="post" action="<?php echo url('administrator/update_pekerjaan'); ?>">
    
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editedModalLabel">Form Edit Pekerjaan</h5>
                    ...
                    <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Form</strong> Edit Pekerjaan
                                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Form Pekerjaan</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div style="float:left;"><h4 class="card-title">Form  Pekerjaan </h4></div>
                                <br clear="all" /><p></p>
                                <!-- <h6 class="card-subtitle">Upload File Gallery Anda <code>.dropzone</code> to form.</h6> -->
                                
                                
                                <form class="dropzone" method="post"  id="form_upload_dropzone" action="<?php echo url('administrator/tambah_pekerjaan'); ?>">
                                <p></p>
                                <h6 class="card-subtitle">&nbsp; List  Pekerjaan </h6>
                                
                                {{ csrf_field() }}

                                @if ($errors->has('inp_nama_pekerjaan'))
                                    <div class="alert alert-danger alert-block col-md-12">
                                        <button type="button" class="close" data-dismiss="alert">×</button>	
                                            <strong>{{ $errors->first('inp_nama_pekerjaan') }}</strong>
                                    </div><p></p>
                                @endif
                                    ...
                                    <div class="row" style="padding:20px; box-sizing:border-box;">
                                        ...
                                        <div class="col-md-10 col-8">
                                            Nama  Pekerjaan :  <span id="span_alt_new" class="sp_req_class" style="color:#FF0000; display:none;"> ( Required ) </span> 
                                            <input type="text" class="form-control" name="inp_nama_pekerjaan" id="inp_nama_pekerjaan" placeholder="input Nama Pekerjaan" required="required" />
                                        </div>
                                 ...
                                 <table id="myTable" class="table table-bordered table-striped border">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript:void(0)" onclick="edit_modal(<?php echo $rows->id_list_pekerjaan; ?>)"> <i class="icon-pencil"></i> Edit </a> &nbsp; <a href="javascript:void(0)" onclick="hapus_modal(<?php echo $rows->id_list_pekerjaan; ?>)"> <i class="icon-trash"></i> Delete </a></td>
                                            </tr>
                                            <?php
                                            $num++;
                                            }
    ...
    //     });
        ...
        function hapus_modal(index){
            ...
            if(con == true){
                $.ajax({
                    ...
                    url:url_menu_apis+"/"+"post_hapus_pekerjaan_new/"+index,
                    success:function(data){
                        
                        window.location = url_menu_apis+"/"+"pekerjaan/";
        ...
        function edit_modal(index){
            ...
            $.ajax({
                type:"GET",
                data:"id="+index,
                url:url_menu_apis+"/"+"get_detail_pekerjaan/"+index,
                dataType:"json",
                success:function(data){
                    

                    $("#edit_hidden_textfield").val(data.id_list_pekerjaan);
                    $("#edit_text_title_new").val(data.nama_pekerjaan);
