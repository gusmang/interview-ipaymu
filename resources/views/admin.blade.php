...
<head>
    ...
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="<?php echo url('dstokel'); ?>/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    <!--Toaster Popup message CSS -->
    <link href="<?php echo url('dstokel'); ?>/assets/node_modules/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- Morris CSS -->
    <link href="<?php echo url('dstokel'); ?>/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo url('dstokel'); ?>/dist/css/style.min.css" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="<?php echo url('dstokel'); ?>/dist/css/pages/dashboard1.css" rel="stylesheet">
...
<body class="skin-blue fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">D-Benang admin</p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo url('dstokel'); ?>/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo url('dstokel'); ?>/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="<?php echo url('dstokel'); ?>/assets/images/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo url('dstokel'); ?>/assets/images/big/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo url('dstokel'); ?>s/assets/images/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="<?php echo url('dstokel'); ?>/assets/images/users/1.jpg" alt="user-img" class="img-circle"><span class="hide-menu">Prof. Mark</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="javascript:void(0)"><i class="ti-user"></i> About Us</a></li>
                        ...
                        <li class="nav-small-cap">--- SLIDER & GALLAERY</li>
                        <li> <a class="waves-effect waves-dark" href="university-events.html"><i class="ti-gallery"></i><span class="hide-menu">SlideShow</span></a></li>
                        <li> <a class="waves-effect waves-dark" href="university-events.html"><i class="ti-gallery"></i><span class="hide-menu">Gallery</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <img class="img-responsive" alt="user" src="<?php echo url('dstokel'); ?>/dist/images/big/c2.jpg">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <img class="img-responsive" alt="user" src="<?php echo url('dstokel'); ?>/dist/images/big/c1.jpg">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <img class="img-responsive" alt="user" src="<?php echo url('dstokel'); ?>/dist/images/big/c4.jpg">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <img class="img-responsive" alt="user" src="<?php echo url('dstokel'); ?>/dist/images/big/c3.jpg">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/1.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/3.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/4.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/5.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/6.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/7.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo url('dstokel'); ?>/assets/images/users/8.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
